...
class UserInfoVC: UIViewController {
    ...
    func configureUIElements(with user: User) {
        self.add(childVC: KGRepoItemVC(user: user, delegate: self), to: self.itemViewOne)
        self.add(childVC: KGFollowerItemVC(user: user, delegate: self), to: self.itemViewTwo)
...
extension UserInfoVC: KGRepoItemVCDelegate {
...
extension UserInfoVC: KGFollowerItemVCDelegate {
